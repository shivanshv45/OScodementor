        ...
        <div className="space-y-3">
          {[
            ...
            return (
              <div
                key={step.key}
                className={`flex items-center gap-3 text-sm transition-all duration-500 ${isActive
              ...
              >
                <div className={`w-5 h-5 flex items-center justify-center ${isActive ? 'text-accent' : isCompleted ? 'text-green-400' : 'text-muted-foreground/40'
                  }`}>
